...
if ($GLOBALS['tablehandlings'][$asstable]['SENTENCETABLE'])
   { $nameoverride = $GLOBALS['tablehandlings'][$asstable]['SENTENCETABLE'];
      ...
      $nameoverride = "Sentence for: " . stripslashes ($nameoverride);
   }
