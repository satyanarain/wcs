...
$portal = 'DefendantsAdministration';
$table = 'defendantstable';
...
if ($GLOBALS['tablehandlings'][$asstable]['DEFENDANTSTABLE'])
   { $nameoverride = $GLOBALS['tablehandlings'][$asstable]['DEFENDANTSTABLE'];
      ...
      foreach ($row as $key => $value)
                   { $nameoverride = str_replace ($key, $value, $nameoverride);
                   }
      $nameoverride = "Accused: " . stripslashes ($nameoverride);
   }
