...
if ((isset ($_POST['deleteid'])) && ($_POST['deleteid'] >= 1) && _deleteAllowed ())
   { _setField ($table, 'DELETED', $_POST['deleteid'], $GLOBALS['timestamp'], $_POST['id']);
      _onDelete_evidencetable ($table, $_POST['deleteid'], $asstable, $assrec);
   }

/* ---------------------------------------------------------------- */

if ($GLOBALS['tablehandlings'][$asstable]['EVIDENCETABLE'])
   { //$nameoverride = $GLOBALS['tablehandlings'][$asstable]['EVIDENCETABLE'];
